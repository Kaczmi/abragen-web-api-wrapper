...
class ImportQuery extends Query
{
    ...
    public function getQuery(): string
    {
        ...
        $mergedCommands = QueryHelpers::mergeCommands($this->queryServant, [\AbraApi\Commands\ParamsCommand::class,
            \AbraApi\Commands\InputDocumentsCommand::class,
            \AbraApi\Commands\OutputDocumentCommand::class]);
